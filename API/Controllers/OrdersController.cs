...
namespace API.Controllers
{
    ...
    public class OrdersController : BaseApiController
    {
        ...
        public async Task<ActionResult<IReadOnlyList<OrderToReturnDto>>> GetOrdersForUser()
        {
            ...
            var orders = await _orderService.GetOrderForUserAsyn(email);
        ...
        public async Task<ActionResult<OrderToReturnDto>> GetOrderByIdUser(int id)
        {
            ...
            var order = await _orderService.GetOrderByIdAsyn(id, email);
        ...
        {
            return Ok(await _orderService.GetDiliveryMethodsAsync());
        }
    }
}